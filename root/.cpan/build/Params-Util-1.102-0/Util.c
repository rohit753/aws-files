...
XS_EUPXS(XS_Params__Util__XScompiled); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Params__Util__XScompiled)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
#  endif
        ...
        newXS_deffile("Params::Util::_XScompiled", XS_Params__Util__XScompiled);
#if PERL_VERSION_LE(5, 21, 5)
